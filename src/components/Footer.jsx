...
const Footer = () => {
  return (
    <>
      <div className="flex items-center justify-between flex-wrap bg-[#262626] py-4 px-6 lg:px-40 shadow-xl">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          <div>
            <p className="text-lg">Contact Me</p>
            <p className="text-md">Tel No: +250781161254</p>
            <p className="text-md">Email: nijohn0006@gmail.com</p>
          </div>
        </div>
        <div className="flex items-center flex-shrink-0 text-white mr-6 text-xl">
          <p className="lg:text-center text-white">
            &copy; John Niyontwali 2022
          </p>
        </div>
